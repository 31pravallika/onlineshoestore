	...
	<div id="header">
		...
		<label>Online Shoe Store</label>
			<ul>
				...
				<li><a href="#login"   data-toggle="modal">User Login</a></li>
				<li><a href="#admin"   data-toggle="modal">Admin Login</a></li>
			</ul>
	</div>
	<div id="admin" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				...
				<div class="modal-body">
					<form method="post">
						<?php
						$err1=filter_input(INPUT_GET,'error1');
						if ($err1==="alogin") echo "<script>alert('Invalid Credentials');</script>"
						?>
					<center>
						<input type="text" name="username" placeholder="Username" style="width:250px;">
		...
		<div id="signup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					...
					<form method="post">
						...
						<input type="text" name="mi" placeholder="Middle Initial" maxlength="15" required>
...
<div id="container">
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Online Shoe Store</p>
		</div>
