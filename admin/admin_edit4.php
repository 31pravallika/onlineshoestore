...
<div id="container">
						...
						?>
				<div id="account">
					<form method="POST" action="../function/edit_product4.php">
						<center>
						<h3 style="color:white;">Edit Product details...</h3>
							...
							<tr>
								<td><input type="text" name="category" value="running"></td>
							</tr>
                            <tr>
									<td></td><td><input type="submit" name="edit4" value="Save Changes" class="btn btn-primary">&nbsp;<a href="admin_running.php"><input type="button" name="cancel" value="Cancel" class="btn btn-danger"></a></td>
								</tr>
							</table>
						</center>
					</form>
