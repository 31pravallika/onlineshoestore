...
<div id="container">
						...
						?>
				<div id="account">
					<form method="POST" action="../function/edit_product3.php">
						<center>
						<h3 style="color:white;">Edit Product details...</h3>
							...
							<tr>
								<td><input type="text" name="category" value="basketball"></td>
							</tr>
                            <tr>
									<td></td><td><input type="submit" name="edit3" value="Save Changes" class="btn btn-primary">&nbsp;<a href="admin_product.php"><input type="button" name="cancel" value="Cancel" class="btn btn-danger"></a></td>
								</tr>
							</table>
						</center>
					</form>
