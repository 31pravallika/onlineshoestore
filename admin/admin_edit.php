...
<div id="container">
						...
						?>
				<div id="account">
					<form method="POST" action="../function/edit_product.php">
						<center>
						<h3 style="color:white;">Edit Product details...</h3>
                            ...
                            <tr>
									<td></td><td><input type="submit" name="edit1" value="Save Changes" class="btn btn-primary">&nbsp;<a href="admin_feature.php"><input type="button" name="cancel" value="Cancel" class="btn btn-danger"></a></td>
								</tr>
							</table>
						</center>
					</form>
