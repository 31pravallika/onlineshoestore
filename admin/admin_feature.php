...
<div id="header" style="position:fixed;">
	...
	<a href="#delete" role="button"class="btn btn-info" data-toggle="modal" style="position:absolute;margin-left:380px;margin-top:140px;z-index:-1000;"><i class="icon-minus-sign icon-white"></i>Delete Product</a>
		<div id="delete" class="modal hide fade" tabindex=-1 role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLael">Delete Product...</h3>
			</div>
			<div class="modal-body">
				<form method="post" enctype="multipart/form-data">
					<table>
						<tr>
							<td><input type=number name="product_id" style="width:250px;" required></td>
						</tr>
					</table>
			</div>
	...
	<?php
			if(isset($_POST['delete']))
			{
				...
				$conn->query("DELETE FROM product WHERE product_id = '$p_id'");
					...
					$code = rand(0,98987787866533499);
								...
								else
								{
									...
									else
									{
										...
										$q1=$conn->query("INSERT INTO `product` (product_id, product_name, product_price, product_size, product_image, brand, category) VALUES ('$product_code','$product_name','$product_price','$product_size','$name', '$brand', '$category')") or die (mysqli_error());
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='admin_edit.php?id=".$id."'><input type='button' class='btn btn-primary' name='edit1' value='Edit'></a>";
					?>
					</td>
				</tr>
				<?php
